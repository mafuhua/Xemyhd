...
public class WeifuKuanPager extends BaseFragment {
    ...
    private void getOrderList() {
        XUtils.xUtilsGet(ContactURL.OrderList_URL + MainActivity.useruid+"/type/0", new Callback.CommonCallback<String>() {
            @Override
            public void onSuccess(String result) {
                Log.d("mafuhua", "------OrderList_URL-----" + result);
                Log.d("mafuhua", "------OrderList_URL-----" + ContactURL.OrderList_URL + MainActivity.useruid+"/type/0");
                orderList.clear();
                Gson gson = new Gson();
