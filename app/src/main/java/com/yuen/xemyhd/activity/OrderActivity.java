...
public class OrderActivity extends AppCompatActivity {
    ...
    private void postOrder() {
        ...
        XUtils.xUtilsPost("http://192.168.0.106/xiaoermei/OrderRmb/doPay", paymap, new Callback.CommonCallback<String>() {
    ...
    private void getOrder() {
        XUtils.xUtilsGet("http://192.168.0.105/xiaoermei/shopapi/order_read", new Callback.CommonCallback<String>() {
